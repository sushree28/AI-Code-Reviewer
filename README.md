...
An AI-powered GitHub App that automatically reviews Pull Requests the moment they are opened. Four specialized agents — static analysis, security, style, and architecture — analyze the code diff in parallel and post inline comments directly on the PR. Built on LangGraph, deployed on AWS EKS.
...
3. [Phase 1 — Accounts You Need](#3-phase-1--accounts-you-need)
4. [Phase 2 — Install Tools on Your Windows Machine](#4-phase-2--install-tools-on-your-windows-machine)
5. [Phase 3 — AWS Account Setup](#5-phase-3--aws-account-setup)
6. [Phase 4 — GitHub Repository Setup](#6-phase-4--github-repository-setup)
7. [Phase 5 — Create GitHub App](#7-phase-5--create-github-app)
8. [Phase 6 — LangFuse Setup](#8-phase-6--langfuse-setup)
9. [Phase 7 — OpenAI API Key](#9-phase-7--openai-api-key)
10. [Phase 8 — Provision AWS Infrastructure with Terraform](#10-phase-8--provision-aws-infrastructure-with-terraform)
11. [Phase 9 — Configure GitHub Secrets](#11-phase-9--configure-github-secrets)
12. [Phase 10 — First Deployment via GitHub Actions](#12-phase-10--first-deployment-via-github-actions)
13. [Phase 11 — Connect kubectl to EKS](#13-phase-11--connect-kubectl-to-eks)
14. [Phase 12 — Apply Kubernetes Manifests](#14-phase-12--apply-kubernetes-manifests)
15. [Phase 13 — Set Up Grafana and Prometheus](#15-phase-13--set-up-grafana-and-prometheus)
16. [Phase 14 — Set Up LangFuse Tracing](#16-phase-14--set-up-langfuse-tracing)
17. [Phase 15 — Update GitHub App Webhook URL](#17-phase-15--update-github-app-webhook-url)
18. [Phase 16 — End-to-End Test](#18-phase-16--end-to-end-test)
19. [Accessing All Dashboards and UIs](#19-accessing-all-dashboards-and-uis)
20. [How the Weekly Evaluation Works](#20-how-the-weekly-evaluation-works)
21. [How to Check If Everything is Running](#21-how-to-check-if-everything-is-running)
22. [Troubleshooting](#22-troubleshooting)
23. [Cost Estimate](#23-cost-estimate)
24. [Teardown — Complete Cleanup](#24-teardown--complete-cleanup)
...
## 4. Phase 2 — Install Tools on Your Windows Machine
...
### 4.6 Verify all tools are installed
...
## 5. Phase 3 — AWS Account Setup

### 5.1 Create an IAM User for CLI access
...
### 5.2 Configure AWS CLI with your credentials
...
### 5.4 Create OIDC Identity Provider for GitHub Actions
...
### 5.5 Create IAM Role for GitHub Actions
...
### 6.1 Create the repository on GitHub
...
### 6.2 Create a Personal Access Token for pushing code
...
### 6.3 Push the project code to GitHub
...
### 7.3 Set Repository Permissions
...
### 7.7 Install the app on your repository
...
## 10. Phase 8 — Provision AWS Infrastructure with Terraform
...
### 10.1 Open CMD and navigate to the Terraform folder
...
### 10.3 Preview what Terraform will create
...
### 10.5 Save all the output values
...
## 11. Phase 9 — Configure GitHub Secrets
...
### 11.1 Go to your repository secrets page
...
### 11.2 Add every secret one by one
...
## 12. Phase 10 — First Deployment via GitHub Actions
...
### 12.1 Trigger all 5 pipelines for the first deployment
...
### 12.4 Re-trigger all 5 pipelines after Phase 12 is complete
...
### 12.5 How to redeploy a single service later
...
## 13. Phase 11 — Connect kubectl to EKS
...
### 13.1 Update your kubeconfig file
...
## 14. Phase 12 — Apply Kubernetes Manifests

This deploys all your services onto the EKS cluster.

### 14.1 Update the ConfigMap with your real Redis URL
...
### 14.2 Fill in the Kubernetes secret file
...
### 14.2 Navigate to the k8s folder

```
cd "D:\MAJOR PROJECT KRISH SIR\ai-code-reviewer\infra\k8s"
```

### 14.3 Apply everything in exact order
...
### 14.4 Verify all pods are running
...
## 15. Phase 13 — Set Up Grafana and Prometheus
...
### 15.1 Add Helm chart repositories
...
### 15.2 Install EBS CSI Driver (required for Prometheus storage)
...
### 15.4 Apply your Prometheus scrape config
...
### 15.6 Get the Grafana admin password
...
### 15.9 Add Prometheus as a data source
...
### 15.10 Import your pre-built dashboard
...
## 16. Phase 14 — Set Up LangFuse Tracing
...
### 16.1 Check your LangFuse region
...
### 16.2 Update configmap.yaml with the correct host
...
### 16.3 Verify the Langfuse keys in the Kubernetes secret
...
### 16.4 Verify traces are appearing
...
### 16.5 Open the LangFuse dashboard
...
## 18. Phase 16 — End-to-End Test

### 18.1 Install the GitHub App on your test repository
...
### 18.2 Make sure all pods are Running
...
### 18.3 Trigger all 5 pipelines and wait for green
...
### 18.4 Create a branch and open a Pull Request on your test repository
...
## 19. Accessing All Dashboards and UIs
...
## 20. How the Weekly Evaluation Works
...
## 21. How to Check If Everything is Running
...
### 24.2 Check for orphaned resources
...
## 25. Cleanup — Correct Order to Avoid Errors
